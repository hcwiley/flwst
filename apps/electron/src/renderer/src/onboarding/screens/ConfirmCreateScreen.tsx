...
export function ConfirmCreateScreen({
  ...
  return (
    ...
    >
      ...
      <Stack gap='$3' marginTop='$2' padding='$4' backgroundColor='$backgroundHover' borderRadius='$4'>
        <Text fontSize='$3'>• Flow State page</Text>
        <Text fontSize='$3'>• Daily Notes database</Text>
        <Text fontSize='$3'>• To-Dos database</Text>
      </Stack>
      <Text fontSize='$3' opacity={0.7} marginTop='$2'>
      ...
      <Stack flexDirection='row' gap='$3' marginTop='$4'>
        ...
        <Button onPress={onConfirm} theme='active' size='$4' flex={1}>
          Create Resources
        </Button>
      </Stack>
    </Stack>
